...
import Layan.Exceptions.LayanErrors;
...
public class Parser {
    ...
    private LayanAST declarationStatements(){ // rule represent the declaration statements include
        // variable declaration, class declaration, object declaration
    ...
    private ResolutionObject resolutionObject(){
        ...
        ResolutionObject resolutionObject = null;

        while (getLookaheadType(1) == Tokens.DOT){
            match(Tokens.DOT);
            ID member;
    ...
    private MethodDeclaration methodDeclaration(){
        ...
        List<LayanAST> para = new ArrayList<LayanAST>();
